...
<section class="flex min-h-screen md:h-screen">
    ...
    <div class="grow w-4/5 flex flex-col h-screen">
        <div class="grow-0 flex justify-between items-center sticky top-0 left-0 right-0 bg-indigo-500 p-3 h-fit">
            <h2  class="outline-none text-xl font-bold text-zinc-100"><i class="bi bi-clipboard-fill"></i> Buyurtmalar tarixi</h2>
            <button on:click={() => show_add = true} class="bg-zinc-100 px-4 py-2 text-lg text-slate-600 font-bold rounded-md shadow-md">Filtrlash <i class="bi bi-filter"></i></button>
        </div>
