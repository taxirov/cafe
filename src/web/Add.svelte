...
<section class="flex min-h-screen md:h-screen">
    ...
    <div class="w-4/5 left-0 flex flex-col h-screen">
        <div class="grow-0 flex justify-between items-center sticky top-0 left-0 right-0 bg-indigo-500 px-3 py-4 h-fit">
            <h2  class="outline-none text-zinc-100 text-2xl font-bold"><i class="bi bi-database-fill-gear text-2xl"></i> Boshqarish</h2>
        </div>
        <div class="grow flex flex-col gap-3 p-5 overflow-y-scroll">
            ...
            <div class="rooms flex flex-col gap-3 p-3 border-t-8 border-pink-500 bg-white rounded-xl shadow-md">
                ...
                <table class="{rooms_class} border-collapse border border-slate-500 text-medium">
                    <thead>
                        <tr>
                            <th class="border border-slate-600 text-center">ID</th>
                            <th class="border border-slate-600 text-center">Ismi</th>
                    ...
                    <tbody> 
                        {#each $roomStore as room}
                            ...
                            <tr>
                                ...
                                {/if}
                                {#if screen.width > 500}
                                    <td class="border border-slate-600 text-center">{room.desc}</td>
                                {/if}
                                <td class="border border-slate-600 text-center">
